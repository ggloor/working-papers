...
```{r fig2b, echo=FALSE, fig.cap="Clustering of the principal component coordinates of the CLR transformed relative abundances of the extracted conjugative regions from the assemblies of North American datasets. Ellipses represent a 95 percent CI using a multivariate t-distribution.", out.width = '100%'}
...
```{r fig3b, echo=FALSE, fig.cap="Clustering of the principal component coordinates of the CLR transformed relative abundances of the extracted conjugative regions from the genome database. Ellipses represent a 95 percent CI using a multivariate t-distribution.", out.width = '100%'}
